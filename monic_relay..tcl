...
proc carimonic {nick uhost hand chan text} {
	...
	if {$nick == "kopiFC"} {
		if {![regexp {[A-Za-z]} [lindex $text 0]]} {
			set nicksebelah [lindex $text 1] ; regsub -all {\[|\]|\[\]} $nicksebelah {} nicksebelah ; set nicksebelah [regsub -all {\002} $nicksebelah ""]
			set ranidups [lindex $rancmonic [rand [llength $rancmonic]]]
			regsub -all "%nick" $ranidups $nicksebelah ranidups
			regsub -all "%mnick" $ranidups $mnick ranidups
			puthelp "PRIVMSG $chan :$ranidups"
			return 0
		}
		set nicksebelah [lindex $text 0] ; regsub -all {\[|\]|\[\]} $nicksebelah {} nicksebelah ; set nicksebelah [regsub -all {\002} $nicksebelah ""]
		set ranidups [lindex $rancmonic [rand [llength $rancmonic]]]
		regsub -all "%nick" $ranidups $nicksebelah ranidups
		regsub -all "%mnick" $ranidups $mnick ranidups
		puthelp "PRIVMSG $chan :$ranidups"
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {![matchattr $nick n]} {
			if {$nick == "kopiFC"} {
				if {![regexp {[A-Za-z]} [lindex $text 0]]} {
					set nicksebelah [lindex $text 1] ; regsub -all {\[|\]|\[\]} $nicksebelah {} nicksebelah ; set nicksebelah [regsub -all {\002} $nicksebelah ""]
					puthelp "PRIVMSG $chan :$nicksebelah siapa sih sok perintah² monic"
					return 0
				}
				set nicksebelah [lindex $text 0] ; regsub -all {\[|\]|\[\]} $nicksebelah {} nicksebelah ; set nicksebelah [regsub -all {\002} $nicksebelah ""]
				puthelp "PRIVMSG $chan :$nicksebelah siapa sih sok perintah² monic"
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {![matchattr $nick n]} {
			if {$nick == "kopiFC"} {
				if {![regexp {[A-Za-z]} [lindex $text 0]]} {
					set nicksebelah [lindex $text 1] ; regsub -all {\[|\]|\[\]} $nicksebelah {} nicksebelah ; set nicksebelah [regsub -all {\002} $nicksebelah ""]
					puthelp "PRIVMSG $chan :Emang $nicksebelah siapa suruh² monic mingkem"
					return 0
				}
				set nicksebelah [lindex $text 0] ; regsub -all {\[|\]|\[\]} $nicksebelah {} nicksebelah ; set nicksebelah [regsub -all {\002} $nicksebelah ""]
				puthelp "PRIVMSG $chan :Emang $nicksebelah siapa suruh² monic mingkem"
...
##  monic  ##
bind pubm - "* mon" monicrelay_speak
bind pubm - "* monic" monicrelay_speak
bind pubm - "* Mon" monicrelay_speak
bind pubm - "* Monic" monicrelay_speak

set monrelay(antiflood) 15

proc monicrelay_speak {nick uhost hand chan text} {
	global botnick ranmonic vrespon monrelay
	if {![channel get $chan talk]} { return 0 }
	set nicksebelah [lindex $text 0] ; regsub -all {\[|\]|\[\]} $nicksebelah {} nicksebelah ; set nicksebelah [regsub -all {\002} $nicksebelah ""]
	set nicksebelah [regsub -all {\002} $nicksebelah ""]
	if {[info exists monrelay(floodprot)]} {
		set diff [expr [clock seconds] - $monrelay(floodprot)]
		if {$diff < $monrelay(antiflood)} {
			return 0
		}
		catch { unset diff }
	}
	set monrelay(floodprot) [clock seconds]
	
	if {$nick == "kopiFC"} {
		if {[llength $text] < 3} {
			if {$nicksebelah == "Vaksin"} {
				set vrsponrelayquakes [lindex $vrespon [rand [llength $vrespon]]]
				putserv "PRIVMSG $chan :$vrsponrelayquakes"
				return 0
			} else {
				set monicsrelayquakes [lindex $ranmonic [rand [llength $ranmonic]]]
				regsub -all "%nick" $monicsrelayquakes $nicksebelah monicsrelayquakes
				putserv "PRIVMSG $chan :$monicsrelayquakes"
				return 0
			}
		}
	}
...
proc blum_speak {nick host hand chan text} {
	global ranblum
	if {![channel get $chan talk]} { return 0 }
	if {[string match "* \[*]\[*]\[*]\ *" [string tolower $text]]} { return 0 }
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				set nicksebelah [lindex $text 1] ; regsub -all {\[|\]|\[\]} $nicksebelah {} nicksebelah ; set nicksebelah [regsub -all {\002} $nicksebelah ""]
				set blumquakes [lindex $ranblum [rand [llength $ranblum]]]
				regsub -all "%nick" $blumquakes $nick blumquakes
				putserv "PRIVMSG $chan :$blumquakes"
				return 0
			}
			set nicksebelah [lindex $text 0] ; regsub -all {\[|\]|\[\]} $nicksebelah {} nicksebelah ; set nicksebelah [regsub -all {\002} $nicksebelah ""]
			set blumquakes [lindex $ranblum [rand [llength $ranblum]]]
		...
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				if {[string match "siapa *" [string tolower $text]] || [string match "* siapa *" [string tolower $text]]} {
					...
					regsub -all "%nick" $siapayankvaks $nicksebelah siapayankvaks
	...
	if {[string match -nocase "*vaksin*" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $yankvaks $nicksebelah yankvaks
		...
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				if {[string match "* org *" [string tolower $text]] || [string match "* orang *" [string tolower $text]] || [string match "* pacar *" [string tolower $text]]} {
					...
					putserv "PRIVMSG $chan :kalo $nicksebelah org mana?"
					return 0
				}
			}
			set nicksebelah [lindex $text 0] ; regsub -all {\[|\]|\[\]} $nicksebelah {} nicksebelah ; set nicksebelah [regsub -all {\002} $nicksebelah ""]
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $tlpons $nicksebelah tlpons
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $bbms $nicksebelah bbms
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		...
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $fbs $nicksebelah fbs
...
proc slkon_speak {nick uhost hand chan text} {
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				set nicksebelah [lindex $text 1] ; regsub -all {\[|\]|\[\]} $nicksebelah {} nicksebelah ; set nicksebelah [regsub -all {\002} $nicksebelah ""]
				regsub -all {[^\u0020-\u007e]+} $nicksebelah "" nicksebelah
				regsub -all {[\u0000-\u001f\u007f]+} $nicksebelah "" nicksebelah
				set slkons [lindex $ranslkon [rand [llength $ranslkon]]]
				putserv "PRIVMSG $chan :$slkons"
				putserv "PRIVMSG $chan :emangnya punya $nicksebelah suntikan"
				return 0
			}
			set nicksebelah [lindex $text 0] ; regsub -all {\[|\]|\[\]} $nicksebelah {} nicksebelah ; set nicksebelah [regsub -all {\002} $nicksebelah ""]
			regsub -all {[^\u0020-\u007e]+} $nicksebelah "" nicksebelah
		...
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				if {[string match "* yuk *" [string tolower $text]] || [string match "* yok *" [string tolower $text]]} {
					...
					regsub -all "%nick" $pcarans $nicksebelah pcarans
...
proc pcar_speak {nick uhost hand chan text} {
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				set nicksebelah [lindex $text 1] ; regsub -all {\[|\]|\[\]} $nicksebelah {} nicksebelah ; set nicksebelah [regsub -all {\002} $nicksebelah ""]
				if {[string match -nocase "*vaksin*" [string tolower $text]] && ![string match "*ayank*" [string tolower $text]]} {
					putserv "PRIVMSG $chan :tanya aja sendiri"
					return 0
				}
				if {[string match -nocase "* pacar monic *" [string tolower $text]] || [string match -nocase "* pacar nya monic *" [string tolower $text]] || [string match -nocase "* pacar mu *" [string tolower $text]]} {
					set pcars [lindex $ranpcar [rand [llength $ranpcar]]]
					regsub -all "%nick" $pcars $nicksebelah pcars
					putserv "PRIVMSG $chan :$pcars"
					return 0
				}
				if {[string match "* aku *" [string tolower $text]]} {
					putserv "PRIVMSG $chan :emang ada yang mau sama kamu?"
					return 0
				}
				if {[string match "*punya*" [string tolower $text]] || [string match "*kamu*" [string tolower $text]] || [string match "lu *" [string tolower $text]] || [string match "* lu *" [string tolower $text]] || [string match "* lu" [string tolower $text]] || [string match "elu *" [string tolower $text]] || [string match "* elu *" [string tolower $text]] || [string match "* elu" [string tolower $text]] || [string match "* mu *" [string tolower $text]] } {
					...
					regsub -all "%nick" $pcarsorg $nicksebelah pcarsorg
...
proc pelitt_speak {nick uhost hand chan text} {
	...
	if {![channel get $chan talk]} { return 0 }
	if {[string match "* \[*]\[*]\[*]\ *" [string tolower $text]] || [string match "* tau *" [string tolower $text]]} { return 0 }
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				set nicksebelah [lindex $text 1] ; regsub -all {\[|\]|\[\]} $nicksebelah {} nicksebelah ; set nicksebelah [regsub -all {\002} $nicksebelah ""]
				set pelitts [lindex $ranpelitt [rand [llength $ranpelitt]]]
				regsub -all "%nick" $pelitts $nicksebelah pelitts
...
proc slp_speak {nick uhost hand chan keyword arg} {
	...
	if {![channel get $chan talk]} { return 0 }
	if {[string match "* \[*]\[*]\[*]\ *" [string tolower $arg]]} { return 0 }
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		...
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $garas $nicksebelah garas
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		...
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $kyaks $nicksebelah kyaks
		...
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				if {[string match "* elu *" [string tolower $text]] || [string match "* lu *" [string tolower $text]]} {
					...
					regsub -all "%nick" $ubras $nicksebelah ubras
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $bauus $nicksebelah bauus
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		...
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $pernahs $nicksebelah pernahs
		...
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				if {[string match "gw *" [string tolower $text]] || [string match "gua *" [string tolower $text]] || [string match "gue *" [string tolower $text]]} {
					...
					regsub -all "%nick" $gwhajarchans $nicksebelah gwhajarchans
					putserv "PRIVMSG $chan :$gwhajarchans"
					return 0
				}
				set hajarchans [lindex $ranhajarchan [rand [llength $ranhajarchan]]]
				regsub -all "%nick" $hajarchans $nicksebelah hajarchans
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $galaks $nicksebelah galaks
		...
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				if {[string match "lu *" [string tolower $text]] || [string match "* lu *" [string tolower $text]] || [string match "* lu" [string tolower $text]] || [string match "elu *" [string tolower $text]] || [string match "* elu *" [string tolower $text]] || [string match "* elu" [string tolower $text]] || [string match "lo *" [string tolower $text]] || [string match "* lo *" [string tolower $text]] || [string match "* lo" [string tolower $text]] || [string match "kamu *" [string tolower $text]] || [string match "* kamu *" [string tolower $text]] || [string match "* kamu" [string tolower $text]] || [string match "kmu *" [string tolower $text]] || [string match "* kmu *" [string tolower $text]] || [string match "* kmu" [string tolower $text]]} {
					...
					regsub -all "%nick" $matis $nicksebelah matis
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $umurs $nicksebelah umurs
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $tariks $nicksebelah tariks
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $malus $nicksebelah malus
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $gnduts $nicksebelah gnduts
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $godas $nicksebelah godas
...
proc pilih_speak {nick uhost hand chan text} {
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				set nicksebelah [lindex $text 1] ; regsub -all {\[|\]|\[\]} $nicksebelah {} nicksebelah ; set nicksebelah [regsub -all {\002} $nicksebelah ""]
				if {[lindex $text 2] == "pilih" || [lindex $text 2] == "milih"} {
					if {[lindex $text 3] == "mana"} { puthelp "PRIVMSG $chan :hmmm... yang mana ya" ; return 0 }
					set word1 [lindex $text 3]
					set word2 [lindex $text 5]
				...
				if {[lindex $text 1] == "pilih" || [lindex $text 1] == "milih"} {
					if {[lindex $text 2] == "mana"} { puthelp "PRIVMSG $chan :hmmm... yang mana ya" ; return 0 }
					set word1 [lindex $text 2]
					set word2 [lindex $text 4]
					set pilih1s [lindex $ranpilih1 [rand [llength $ranpilih1]]]
					regsub -all "%word1" $pilih1s $word1 pilih1s
					regsub -all "%word2" $pilih1s $word2 pilih1s
					putserv "PRIVMSG $chan :$pilih1s"
			...
			if {$nick == "kopiFC"} {
				if {![regexp {[A-Za-z]} [lindex $text 0]]} {
					...
					if {[lindex $text 2] == "sama" || [lindex $text 2] == "Sama"} {
						set word1 [lindex $text 4]
						set dias1 [lindex $randia [rand [llength $randia]]]
						regsub -all "%word1" $dias1 $word1 dias1
						putserv "PRIVMSG $chan :$dias1"
						return 0
					}
					if {[lindex $text 3] == "sama" || [lindex $text 3] == "Sama"} {
						set word1 [lindex $text 4]
						set dias1 [lindex $randia [rand [llength $randia]]]
						regsub -all "%word1" $dias1 $word1 dias1
						putserv "PRIVMSG $chan :$dias1"
...
proc speak_apa {nick uhost hand chan text} {
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		...
		if {$nick == "kopiFC"} {
			if {[llength $text] <= 3} { return 0 }
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				set nicksebelah [lindex $text 1] ; regsub -all {\[|\]|\[\]} $nicksebelah {} nicksebelah ; set nicksebelah [regsub -all {\002} $nicksebelah ""]
				if {[lindex $text 3] == "apa"} {
					set apa1 [lindex $text 2]
					set apa2 [lindex $text 4]
			...
			set nicksebelah [lindex $text 0] ; regsub -all {\[|\]|\[\]} $nicksebelah {} nicksebelah ; set nicksebelah [regsub -all {\002} $nicksebelah ""]
			if {[lindex $text 2] == "apa"} {
				set apa1 [lindex $text 1]
				set apa2 [lindex $text 3]
				set apas [lindex $ranapa [rand [llength $ranapa]]]
				regsub -all "%apa1" $apas $apa1 apas
				regsub -all "%apa2" $apas $apa2 apas
				putserv "PRIVMSG $chan :$apas"
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $nikahs $nicksebelah nikahs
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $tulis $nicksebelah tulis
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $bdeks $nicksebelah bdeks
...
proc pnter_speak {nick uhost hand chan text} {
	...
	if {[string match -nocase "*monic*" [string tolower $text]] || [string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "mon *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				set nicksebelah [lindex $text 1] ; regsub -all {\[|\]|\[\]} $nicksebelah {} nicksebelah ; set nicksebelah [regsub -all {\002} $nicksebelah ""]
				if {[lindex $text 2] == "$botnick" || [lindex $text 2] == "Monic" || [string match "lu *" [string tolower $text]] || [string match "* lu *" [string tolower $text]] || [string match "* lu" [string tolower $text]] || [string match "lo *" [string tolower $text]] || [string match "* lo *" [string tolower $text]] || [string match " lo*" [string tolower $text]] || [string match "elo *" [string tolower $text]] || [string match "* elo *" [string tolower $text]] || [string match "* elo*" [string tolower $text]] || [string match "elu *" [string tolower $text]] || [string match "* elu *" [string tolower $text]] || [string match "* elu" [string tolower $text]] || [string match "kamu *" [string tolower $text]] || [string match "* kamu *" [string tolower $text]] || [string match "* kamu" [string tolower $text]]} {
					set pnters [lindex $ranpnter [rand [llength $ranpnter]]]
					regsub -all "%nick" $pnters $nicksebelah pnters
			...
			set nicksebelah [lindex $text 0] ; regsub -all {\[|\]|\[\]} $nicksebelah {} nicksebelah ; set nicksebelah [regsub -all {\002} $nicksebelah ""]
			if {[lindex $text 1] == "$botnick" || [lindex $text 1] == "Monic" || [string match "lu *" [string tolower $text]] || [string match "* lu *" [string tolower $text]] || [string match "* lu" [string tolower $text]] || [string match "lo *" [string tolower $text]] || [string match "* lo *" [string tolower $text]] || [string match " lo*" [string tolower $text]] || [string match "elo *" [string tolower $text]] || [string match "* elo *" [string tolower $text]] || [string match "* elo*" [string tolower $text]] || [string match "elu *" [string tolower $text]] || [string match "* elu *" [string tolower $text]] || [string match "* elu" [string tolower $text]] || [string match "kamu *" [string tolower $text]] || [string match "* kamu *" [string tolower $text]] || [string match "* kamu" [string tolower $text]]} {
				set pnters [lindex $ranpnter [rand [llength $ranpnter]]]
				regsub -all "%nick" $pnters $nicksebelah pnters
				putserv "PRIVMSG $chan :$pnters"
				return 0
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $soris $nicksebelah soris
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $belis $nicksebelah belis
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $nyebelins $nicksebelah nyebelins
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $kills $nicksebelah kills
...
##  hai  ##
bind pubm - hay hai_speak
bind pubm - hai hai_speak
bind pubm - halo hai_speak
bind pubm - hallo hai_speak
bind pubm - hi hai_speak
set ranhai {
	"Hai juga..!!"
	"Hallo %nick"
...
proc hai_speak {nick uhost hand chan text} {
	...
	if {$nick == "kopiFC"} {
		if {![regexp {[A-Za-z]} [lindex $text 0]]} {
			...
			regsub -all "%nick" $hais $nicksebelah hais
...
proc bt_speak {nick uhost hand chan text} {
	...
	if {$nick == "kopiFC"} {
		if {![regexp {[A-Za-z]} [lindex $text 0]]} {
			...
			regsub -all "%nick" $bts $nicksebelah bts
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $kbars $nicksebelah kbars
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $jmkans $nicksebelah jmkans
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $mkans $nicksebelah mkans
		...
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				if {[string match "* ga *" [string tolower $text]] || [string match "* ga" [string tolower $text]] || [string match "* gak *" [string tolower $text]] || [string match "* gak" [string tolower $text]] || [string match -nocase "emang *" [string tolower $text]] || [string match -nocase "mang *" [string tolower $text]] || [string match "* sama *" [string tolower $text]]} {
					...
					regsub -all "%nick" $mauus $nicksebelah mauus
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $bgils $nicksebelah bgils
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $wbs $nicksebelah wbs
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $hjrs $nicksebelah hjrs
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $mjoks $nicksebelah mjoks
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $nylotts $nicksebelah nylotts
	...
	if {([string match "monic *" [string tolower $text]] || [string match "* mon" [string tolower $text]]) && ![string match "* ga *" [string tolower $text]])} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $mniss $nicksebelah mniss
...
proc ngantuk_speak {nick uhost hand chan text} {
	...
	if {$nick == "SmartRadio"} { return 0 }
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				set nicksebelah [lindex $text 1] ; regsub -all {\[|\]|\[\]} $nicksebelah {} nicksebelah ; set nicksebelah [regsub -all {\002} $nicksebelah ""]
				set ngantuks [lindex $ranngantuk [rand [llength $ranngantuk]]]
				regsub -all "%nick" $ngantuks $nicksebelah ngantuks
...
proc hjn_speak {nick uhost hand chan text} {
	...
	if {$nick == "kopiFC"} {
		if {![regexp {[A-Za-z]} [lindex $text 0]]} {
			...
			regsub -all "%nick" $hjns $nicksebelah hjns
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $mkasihs $nicksebelah mkasihs
...
proc lpr_speak {nick uhost hand chan text} {
	...
	if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $lprs $nicksebelah lprs
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		...
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $ciums $nicksebelah ciums
		...
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				if {[string match "*kasih tau jangan*" [string tolower $text]] || [string match "*kasih tau apa jangan*" [string tolower $text]] || [string match "*kasih tau pa jangan*" [string tolower $text]] || [string match "*kasih tau * jangan*" [string tolower $text]] || [string match "*kasih tau * apa jangan*" [string tolower $text]] || [string match "*kasih tau * pa jangan*" [string tolower $text]]} {
					...
					regsub -all "%nick" $ksihtaus $nicksebelah ksihtaus
					putserv "PRIVMSG $chan :$ksihtaus"
					return 0
				}
				set ksihtauus [lindex $ranksihtau2 [rand [llength $ranksihtau2]]]
				regsub -all "%nick" $ksihtauus $nicksebelah ksihtauus
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $lgirajins $nicksebelah lgirajins
		...
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				if {[string match "lagi *" [string tolower $text]] || [string match "* lagi *" [string tolower $text]] || [string match "* lagi" [string tolower $text]] || [string match "lgi *" [string tolower $text]] || [string match "* lgi *" [string tolower $text]] || [string match "* lgi" [string tolower $text]]} {
					...
					regsub -all "%nick" $lgingapains $nicksebelah lgingapains
		...
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				if {[string match "tau *" [string tolower $text]] || [string match "* tau *" [string tolower $text]] || [string match "* tau" [string tolower $text]]} {
					...
					regsub -all "%nick" $dmanataus $nicksebelah dmanataus
					putserv "PRIVMSG $chan :$dmanataus"
					return 0
				}
				set dmanavs [lindex $randrimna [rand [llength $randrimna]]]
				regsub -all "%nick" $dmanavs $nicksebelah dmanavs
...
proc berapa_speak {nick uhost hand chan text} {
	...
	f {[string match {+} [string tolower $text]] || [string match {*} [string tolower $text]] || [string match {/} [string tolower $text]]} { return 0 }
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "*monic*" [string tolower $text]] || [string match "mon *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				set nicksebelah [lindex $text 1] ; regsub -all {\[|\]|\[\]} $nicksebelah {} nicksebelah ; set nicksebelah [regsub -all {\002} $nicksebelah ""]
				set berapas [lindex $ranberapa [rand [llength $ranberapa]]]
				regsub -all "%nick" $berapas $nicksebelah berapas
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "*monic*" [string tolower $text]] || [string match "mon *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $ntons $nicksebelah ntons
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $films $nicksebelah films
...
proc kmana_speak {nick uhost hand chan text} {
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {[lindex $text 1] == " kemana" || [lindex $text 1] == " mana"} { return 0 }
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				set nicksebelah [lindex $text 1] ; regsub -all {\[|\]|\[\]} $nicksebelah {} nicksebelah ; set nicksebelah [regsub -all {\002} $nicksebelah ""]
				if {[string match -nocase "*vaksin*" [string tolower $text]]} {
					set kmanavs [lindex $rankemanav [rand [llength $rankemanav]]]
					regsub -all "%nick" $kmanavs $nicksebelah kmanavs
				...
				if {![string match "* sekolah *" [string tolower $text]]} {
					if {[lindex $text 1] == "pada" || [lindex $text 1] == "kemana" || [string match "*dari*" [string tolower $text]]} { return 0 }
		...
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				if {[string match -nocase "*vaksin*" [string tolower $text]]} {
					...
					regsub -all "%nick" $edanvaks $nicksebelah edanvaks
					putserv "PRIVMSG $chan :$edanvaks"
					return 0
				}
				if {([lindex $text 1] == "Monic" && [lindex $text 2] == "gila") || ([lindex $text 1] == "monic" && [lindex $text 2] == "gila") || [string match "kamu *" [string tolower $text]] || [string match "lu *" [string tolower $text]] || [string match "* lu *" [string tolower $text]] || [string match "* lu" [string tolower $text]]} {
					set edanmons [lindex $ranmonedann [rand [llength $ranmonedann]]]
					regsub -all "%nick" $edanmons $nicksebelah edanmons
					putserv "PRIVMSG $chan :$edanmons"
					return 0
				}
				set edanns [lindex $ranedan [rand [llength $ranedan]]]
				regsub -all "%nick" $edanns $nicksebelah edanns
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $smbongs $nicksebelah smbongs
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		...
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $nkals $nicksebelah nkals
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $kapans $nicksebelah kapans
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $his $nicksebelah his
		...
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				if {[string match "* siapa *" [string tolower $text]]} {
					...
					regsub -all "%nick" $kangensiapa $nicksebelah kangensiapa
					putserv "PRIVMSG $chan :$kangensiapa"
					return 0
				} else {
					set kangens [lindex $rankangen [rand [llength $rankangen]]]
					regsub -all "%nick" $kangens $nicksebelah kangens
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $skuls $nicksebelah skuls
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $mkmanas $nicksebelah mkmanas
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $nyanyis $nicksebelah nyanyis
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $brantems $nicksebelah brantems
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $stans $nicksebelah stans
...
proc liat_speak {nick uhost hand chan text} {
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		...
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				set nicksebelah [lindex $text 1] ; regsub -all {\[|\]|\[\]} $nicksebelah {} nicksebelah ; set nicksebelah [regsub -all {\002} $nicksebelah ""]
				if {[lindex $text 2] == "liat" && [llength $text] == 4} {
					putserv "PRIVMSG $chan :liat apa?"
					return 0
				}
				if {[lindex $text 2] == "lihat" && [llength $text] == 4} {
					putserv "PRIVMSG $chan :lihat apa?"
					return 0
				}
				if {[string match -nocase "*vaksin*" [string tolower $text]]} {
					set lvaks [lindex $liatvak [rand [llength $liatvak]]]
					regsub -all "%nick" $lvaks $nicksebelah lvaks
					putserv "PRIVMSG $chan :$lvaks"
					return 0
				} else {
					if {[llength $text] == 4} { return 0 }
					set liats [lindex $ranliat [rand [llength $ranliat]]]
					regsub -all "%nick" $liats $nicksebelah liats
					putserv "PRIVMSG $chan :$liats"
					putserv "PRIVMSG $chan :$nicksebelah mau nagih utang ya"
					return 0
				}
			}
			set nicksebelah [lindex $text 0] ; regsub -all {\[|\]|\[\]} $nicksebelah {} nicksebelah ; set nicksebelah [regsub -all {\002} $nicksebelah ""]
			if {[lindex $text 1] == "liat" && [llength $text] == 3} {
				putserv "PRIVMSG $chan :liat apa?"
				return 0
			}
			if {[lindex $text 1] == "lihat" && [llength $text] == 3} {
				putserv "PRIVMSG $chan :lihat apa?"
				return 0
			}
			if {[string match -nocase "*vaksin*" [string tolower $text]]} {
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		...
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				set nicksebelah [lindex $text 1] ; regsub -all {\[|\]|\[\]} $nicksebelah {} nicksebelah ; set nicksebelah [regsub -all {\002} $nicksebelah ""]
				putserv "PRIVMSG $chan :tau dong"
				putserv "PRIVMSG $chan :\001ACTION ga kayak $nicksebelah bolot\001"
				return 0
			}
			set nicksebelah [lindex $text 0] ; regsub -all {\[|\]|\[\]} $nicksebelah {} nicksebelah ; set nicksebelah [regsub -all {\002} $nicksebelah ""]
			putserv "PRIVMSG $chan :tau dong"
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		...
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $nunggings $nicksebelah nunggings
		...
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				if {[string match "*salam*" [string tolower $text]]} {
					...
					regsub -all "%nick" $lamkenals $nicksebelah lamkenals
		...
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				if {[string match "dimana *" [string tolower $text]] || [string match "* dimana *" [string tolower $text]] || [string match "* dimana" [string tolower $text]]} {
					...
					regsub -all "%nick" $drmahs $nicksebelah drmahs
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $prgis $nicksebelah prgis
...
proc bosen_speak {nick uhost hand chan text} {
	...
	if {$nick == "kopiFC"} {
		if {![regexp {[A-Za-z]} [lindex $text 0]]} {
			...
			regsub -all "%nick" $bosens $nicksebelah bosens
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $tboks $nicksebelah tboks
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		...
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $mndis $nicksebelah mndis
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $sehats $nicksebelah sehats
	...
	if {[string match "monic *" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "* mon" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $mnyets $nicksebelah mnyets
		...
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				if {[string match -nocase "*vaksin*" [string tolower $text]]} {
					...
					regsub -all "%nick" $homovaks $nicksebelah homovaks
				...
				if {[string match "*lesbi*" [string tolower $text]] && [string match "* apa *" [string tolower $text]]} {
					...
					regsub -all "%nick" $homos $nicksebelah homos
		...
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				if {[string match -nocase "*vaksin*" [string tolower $text]] || [string match "*monic*" [string tolower $text]] || [string match "* kamu *" [string tolower $text]] || [string match "lu *" [string tolower $text]] || [string match "* lu *" [string tolower $text]] || [string match "* lu" [string tolower $text]]} {
					...
					regsub -all "%nick" $suaras $nicksebelah suaras
		...
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				if {[string match -nocase "* monic jelek" [string tolower $text]] || [string match -nocase "monic lebih *" [string tolower $text]] || [string match -nocase "*vaksin*" [string tolower $text]] || [string match -nocase "*v*a*k*s*i*n*" [string tolower $text]]} {
					...
					regsub -all "%nick" $monujlk $nicksebelah monujlk
				...
				if {([lindex $text 0] == "yang" && [lindex $text 3] == "apa") || ([lindex $text 0] == "yg" && [lindex $text 3] == "apa")} {
					...
					set jlknick1 [lindex $text 4]
					set jlknick2 [lindex $text 6]
			...
			if {([lindex $text 0] == "yang" && [lindex $text 3] == "apa") || ([lindex $text 0] == "yg" && [lindex $text 3] == "apa")} {
				...
				set jlknick1 [lindex $text 3]
				set jlknick2 [lindex $text 5]
				set runjlk1s [lindex $runjlk1 [rand [llength $runjlk1]]]
				regsub -all "%sijlk1" $runjlk1s $jlknick1 runjlk1s
				regsub -all "%sijlk2" $runjlk1s $jlknick2 runjlk1s
				putserv "PRIVMSG $chan :$runjlk1s"
	...
	if {[string match "* mon" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $matamus $nicksebelah matamus
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $sepis $nicksebelah sepis
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $syangs $nicksebelah syangs
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $asems $nicksebelah asems
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		...
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $jhatts $nicksebelah jhatts
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $imuts $nicksebelah imuts
		...
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				if {[string match -nocase "*vaksin*" [string tolower $text]]} {
					...
					regsub -all "%nick" $siapavaks $nicksebelah siapavaks
	...
	if {[string match "* mon" [string tolower $text]] || [string match "* monic" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $sores $nicksebelah sores
	...
	if {[string match "* mon" [string tolower $text]] || [string match "* monic" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $mlms $nicksebelah mlms
	...
	if {[string match "* mon" [string tolower $text]] || [string match "* monic" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $pagis $nicksebelah pagis
	...
	if {[string match "* mon" [string tolower $text]] || [string match "* monic" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $siangs $nicksebelah siangs
	...
	if {[string match "monic *" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]]} {
		...
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $diamms $nicksebelah diamms
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		...
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $raniyas $nicksebelah raniyas
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* mon?" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $raniyks $nicksebelah raniyks
	...
	if {([string match "* mon *" [string tolower $text]] && ![string match "* bisa *" [string tolower $nick]]) || ([string match "* mon" [string tolower $text]] && ![string match "* bisa *" [string tolower $nick]]) || ([string match "* monic *" [string tolower $text]] && ![string match "* bisa *" [string tolower $nick]]) || ([string match "* monic" [string tolower $text]] && ![string match "* bisa *" [string tolower $nick]]) || ([string match "mon *" [string tolower $text]] && ![string match "* bisa *" [string tolower $nick]]) || ([string match "monic *" [string tolower $text]] && ![string match "* bisa *" [string tolower $nick]])} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $hitungs $nicksebelah hitungs
	...
	if {[string match "* mon *" [string tolower $text]] || [string match "* mon" [string tolower $text]] || [string match "* monic *" [string tolower $text]] || [string match "* monic" [string tolower $text]] || [string match "mon *" [string tolower $text]] || [string match "monic *" [string tolower $text]]} {
		if {$nick == "kopiFC"} {
			if {![regexp {[A-Za-z]} [lindex $text 0]]} {
				...
				regsub -all "%nick" $monpuasas $nicksebelah monpuasas
		...
		if {![regexp {[A-Za-z]} [lindex $text 0]]} {
			...
			if {[string first m $text] == 0} {
				if {$nick == "Vaksin"} {
					...
					regsub -all "%nick" $mkgets $nicksebelah mkgets
